...
namespace Afrodite_Sistema.Controllers
{
    public class TipoProcedimentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TipoProcedimentoId,NomeTipoProcedimento")] TipoProcedimento tipoProcedimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TipoProcedimentoId,NomeTipoProcedimento")] TipoProcedimento tipoProcedimento)
        {
